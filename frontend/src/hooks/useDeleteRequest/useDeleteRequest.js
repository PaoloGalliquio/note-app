...
export const useDeleteRequest = () => {
  ...
  const executeDeleteRequest = (api) => {
    if (api) {
      return axios
  ...
  function executeDeleteRequestCallback(functionThatReturnsAPI) {
    return function () {
      return executeDeleteRequest(functionThatReturnsAPI);
    };
  }
  ...
  return [executeDeleteRequest, executeDeleteRequestCallback];
};
